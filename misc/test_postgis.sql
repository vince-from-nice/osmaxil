...
SELECT x, y, z FROM point_cloud_of_nice WHERE ST_Intersects(geom, ST_GeomFromText('SRID=3857;POLYGON((797780.39 5412627.1,797787.69 5412629.45,797794.01 5412609.57,797787.56 5412607.54,797786.88 5412607.34,797780.39 5412627.1))', 3857))
SELECT x, y, z FROM point_cloud_of_nice WHERE ST_Intersects(geom, ST_GeomFromText('SRID=3857;POLYGON((797780.39 5412627.1,797787.69 5412629.45,797794.01 5412609.57,797787.56 5412607.54,797786.88 5412607.34,797780.39 5412627.1))', 4326))
SELECT x, y, z FROM point_cloud_of_nice WHERE ST_Intersects(geom, ST_Transform(ST_GeomFromText('SRID=3857;POLYGON((797780.39 5412627.1,797787.69 5412629.45,797794.01 5412609.57,797787.56 5412607.54,797786.88 5412607.34,797780.39 5412627.1))', 3857), 4326))
