...
/**
 * This class is an implementation of AbstractMatchingScorer which is a more complex than other implementations. For each element it first dispatches
 * all its matching imports by their tag value into maps. Note that the name of the relevant tag defined by the matchingTagName attribute. Then for
 * each tag value a total matching scores are calculated by accumulating matching scores of the related imports. The global matching score of the
 * element is the biggest total matching score.
 */
@Component
