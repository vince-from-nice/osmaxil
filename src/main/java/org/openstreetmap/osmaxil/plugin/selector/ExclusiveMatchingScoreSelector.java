...
/**
 * This class is an implementation of AbstractMatchingScorer: It works exactly like the SimpleMatchingImportComparator except that elements with more
 * than one matching import has the minimal global score.
 */
@Component
